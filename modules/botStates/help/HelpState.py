...
class HelpState(BaseState):
    ...
    def receive_message(self, message: Message, user_data: dict):
        if message.text == self.main_button[0]:
            ...
            self.send(
                "Токен доступа к серверу вы получили при регистрации, чтобы вы можете испотзовать его на всех своих устройствах, если вы хотите получить нового пользователя зайдите с другого аккаунта.")
